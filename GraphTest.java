...
public static void main(String[] args) {
    ...
    Vertex l = test2.addVertex("6");
    Vertex n = test2.addVertex("7");
    
    test2.addEdge(z,x,0.26);
    test2.addEdge(z,k,0.38);
    test2.addEdge(x,n,0.34);
    test2.addEdge(y,t,0.29);
    test2.addEdge(t,l,0.52);
    test2.addEdge(k,m,0.35);
    test2.addEdge(k,n,0.37);
    test2.addEdge(m,k,0.34);
    test2.addEdge(m,y,0.32);
    test2.addEdge(l,x,0.4);
